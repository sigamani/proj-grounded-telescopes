...
class TestDockerIntegration:
    ...
    def test_container_startup(self, docker_client):
        ...
        try:
            ...
            assert (
                ...
                or container.attrs["State"]["ExitCode"] == 0
            )
    ...
    def test_ray_import_in_container(self, docker_client):
        ...
        try:
            ...
            assert (
                "Ray initialized" in output_str or "successfully" in output_str.lower()
            )
    ...
    def test_port_exposure(self, docker_client):
        ...
        container = docker_client.containers.create(
            "test-grounded-telescopes",
            ports={"6379/tcp": 6379, "8265/tcp": 8265, "10001/tcp": 10001},
        )
    ...
    def test_entrypoint_and_cmd(self, docker_client):
        ...
        try:
            ...
            container = docker_client.containers.create("test-grounded-telescopes")
            ...
            cmd = config.get("Cmd", [])
            assert any("ray" in str(c) for c in cmd) or any(
                "start" in str(c) for c in cmd
            )
